...
% for neon (he) atom using a single-active electron (sae) approximation Ref.[1], 
...
%
rho_total = 2.*rho_1s + 2.*rho_2s + 6.*rho_2p;
%
...
[En_1s, En_2s, En_2p] % -30.917891993315266  -1.677415077117466  -0.834297086845076
%                     %                                          -0.834            from Ref.[1] 
average_r2 = sum(wr.*rho_total.*r.^2.*r.^2.*4.*pi); % 9.457574052780405
